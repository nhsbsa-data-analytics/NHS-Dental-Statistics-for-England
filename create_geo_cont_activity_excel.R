...
meta_descs <-
  c("The financial year to which the data belongs. For example, 2024/2025.",
    ...
    background and methodology document for this release. ICB level totals do not include activity from H and J
    commissioners, so will not match to totals from other geographical levels.",
...
accessibleTables::write_sheet(
  ...
  notes = c("1. ICB level totals do not include activity from health and justice (H and J) commissioners, so will not match to totals from other geographical levels."),
...
accessibleTables::write_sheet(
  ...
  notes = c("1. Patients seen includes orthodontists visits. It is not possible to determine which patients were seen for orthodontic visits.",
            "2. A patient's age is calculated as at the given date.",
            "3. Population estimates for 2023 and 2024 were not available for NHS region or ICB levels at time of publication, so the 2022 mid-year estimate has been used for 2023/24 and 2024/25. Regional and ICB level numbers
            that are calculated using population data are provisional and will be updated once 2023 and 2024 population estimates are available.",
            "4. Mid-year population estimates from the Office for National Statistics (ONS) have been used. You can find more information about population estimates and a link to their source on the metadata sheet."),
  dataset = geo_table3e,
  column_a_width = 20
)
