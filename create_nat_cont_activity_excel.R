...
meta_descs <-
  c("The financial year to which the data belongs. For example, 2024/2025. Data from previous financial years may have been affected by the COVID-19 pandemic. You can find more information on this in the background and methodology document.",
    ...
    "A UOA is a unit of orthodontic activity, which a dental contract can receive after submitting a valid FP17 form. How many UOAs are awarded depends on a patient's age on the date of assessment. For example, an orthodontic COT for \"assessment and appliance fitted\" for a patient aged under 10 will generally be awarded 4 UOA.",
    "The patient type column groups patients according to whether they are a child, an exempt adult, or a non-exempt adult.",
    "Exemption type is the exemption group of the patient. Adults undergoing NHS dental activity normally pay a set amount of money towards treatment, unless they have a valid exemption. Children aged under 18 at the start of treatment, or under 19 and in full-time education, do not pay for treatment. More information on patient charges and exemptions can by found in the background and methodology document.",
...
openxlsx::setColWidths(
  ...
  widths = c(20, 35, 14, 14, 14, 14, 14, 14, 14, 14, 14, 37, 14)
)
...
accessibleTables::makeCoverSheet(
  ...
  c(
    ...
    "Table_2g_i: Units of dental activity by Dental Care Professional type, treatment band, and financial year",
    "Table_2g_ii: Units of dental activity by Dental Care Professional type, treatment band, and financial quarter",
