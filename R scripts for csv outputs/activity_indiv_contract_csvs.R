#Script to create contract location dental activity data for 2019/20 to 2024/25 by individual contract level
#write to CSV output files, then put these into a ZIP file

#Extract data from contract location dental activity fact table in warehouse
