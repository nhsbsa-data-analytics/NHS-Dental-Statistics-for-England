#Script to create patient location dental activity data for 2019/20 to 2024/25
...
#file saved in working directory due to issue with ONS website
# setwd("Y:\\Official Stats\\Dental\\2024_25\\csvs")
# region_lookup <- get_region_lookups()

#get region codes from lookup
...
#ICB name, ICB ONS code and ICB ODS code can be taken straight from fact table
