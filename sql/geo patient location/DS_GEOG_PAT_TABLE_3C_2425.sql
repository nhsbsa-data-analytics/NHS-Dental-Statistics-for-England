-------------------------------------------------------------------------
-- DENTAL Geographical Patient Activity - Table 3c
-------------------------------------------------------------------------

DROP TABLE dental_geo_pat_table3c_2425;

-- use patient postcode column to map to LA
CREATE TABLE dental_geo_pat_table3c_2425 AS 
...
,fact as  (
  ...
  from
    adults  a
  full outer join -- full join instead of inner, to keep null LA groups where postcode not matched
    children  c
...
--from DENTAL_GEO_PAT_TABLE3C_2425;