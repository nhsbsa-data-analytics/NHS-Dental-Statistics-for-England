...
--script to create new table of DCP COTs by DCP led/DCP assist/Non DCP, and by DCP type

DROP TABLE dental_national_table1g_2425;

CREATE TABLE dental_national_table1g_2425 AS
