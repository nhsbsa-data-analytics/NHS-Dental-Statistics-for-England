-------------------------------------------------------------------------
-- DENTAL National Activity - Table 1c
-------------------------------------------------------------------------

DROP TABLE dental_national_table1c_2425;

CREATE TABLE dental_national_table1c_2425 AS
WITH
fact1 AS (
SELECT treatment_year                                             as treatment_year,    
       COALESCE(patient_charge_status, '0 - All')                         as patient_charge_status,
...
ORDER BY treatment_year DESC, patient_charge_status ASC
;
