...
--drop table ds_pat_clinical_fact_2425 cascade constraints purge;

create table  ds_pat_clinical_fact_2425 compress for  query high  as
...
--fix for single postcode that doesn't map as expected for ICB columns

UPDATE DS_PAT_CLINICAL_FACT_2425
SET
